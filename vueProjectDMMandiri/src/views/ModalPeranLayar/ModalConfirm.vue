...
<script>
import { storeDM } from '@/views/../redux/storePeranLayar'
import FormsConfirm from '@/views/peranLayar/FormsConfirm'
export default {
	name: 'ModalConfirm',
	...
	methods: {
		async submit() {
			await fetch("http://localhost:8080/api/peranLayars/" + this.storeDM.state.formData.id, {
				method: "delete",
				headers: {
