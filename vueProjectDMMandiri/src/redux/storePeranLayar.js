...
const storeDM = new Vuex.Store({
	  state: {
		...
		login: true,
		register: false,
		titleModal:"Tambah Data Peran & Layar",
		warningModal:false,
		confirmModal:false,
		formData:{
			id:'',
