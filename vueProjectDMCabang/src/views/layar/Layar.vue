          ...
          <CForm class="row g-3">
            ...
            <div class="col-auto">
              <div class="row g-3 align-items-center bg-info" style="height:50px;">
                <div class="col-auto">
                  <label for="inputPassword6" class="col-form-label">Pencarian Nama Layar</label>
                </div>
                <div class="col-auto">
...
import ModalAddEdit from '@/views/ModalLayar/ModalAddEdit'
import ModalConfirm from '@/views/ModalLayar/ModalConfirm'
...
export default {
  ...
  methods: {
    ...
    MyfetchData(search = "") {
      fetch("http://localhost:8080/api/layars/LayarData" + "?search=" + search)
        .then(res => res.json())
        .then(
          (result) => {
            0
    ...
    getModalAddForm() {
      ...
      this.storeDM.commit('changeTitleModal', { title: "Tambah Layar Baru" })
    ...
    async getModalEditForm(item) {
      ...
      await this.storeDM.commit('changeTitleModal', { title: "Update Layar" })
