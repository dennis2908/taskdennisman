...
<script>
import { storeDM } from '@/views/../redux/store'
import FormsConfirm from '@/views/userdata/FormsConfirm'
export default {
	name: 'ModalConfirm',
	...
	methods: {
		async submit() {
			await fetch("http://localhost:8080/api/akuns/" + storeDM.state.formData.id, {
				method: "delete",
				headers: {
